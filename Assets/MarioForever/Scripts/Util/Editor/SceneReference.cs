...
namespace SweetMoleHouse.MarioForever.Util.Editor
{
    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
        ...
        static readonly RectOffset BOX_PADDING = EditorStyles.helpBox.padding;
        static readonly float PAD_SIZE = 2f;
        static readonly float LINE_HEIGHT = EditorGUIUtility.singleLineHeight;
        static readonly float PADDED_LINE = LINE_HEIGHT + PAD_SIZE;
        static readonly float FOOTER_HEIGHT = 10f;
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return BOX_PADDING.vertical + LINE_HEIGHT * lines + PAD_SIZE * (lines - 1) + FOOTER_HEIGHT;
        }
